...
export default function CodeInput() {
  ...
  const htmlCodeValue = useSelector((state) => state.CodeInputSlice.html);
  const cssCodeValue = useSelector((state) => state.CodeInputSlice.css);
  const jsCodeValue = useSelector((state) => state.CodeInputSlice.js);
